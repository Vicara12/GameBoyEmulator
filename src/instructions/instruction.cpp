...
int executeInstruction (Byte opcode, Byte data0, Byte data1, State& state)
{
  ...
  case 0x02:
    return instr_LD_mem_r1_nn(REG_BC(state), state.A, state, false);
  case 0x03:
    return -1;
  case 0x04:
    return -1;
  ...
  case 0x12:
    return instr_LD_mem_r1_nn(REG_DE(state), state.A, state, false);
  case 0x13:
    return -1;
  case 0x14:
    return -1;
  ...
  case 0x35:
    return -1;
  case 0x36:
    return instr_LD_mem_r1_nn(REG_HL(state), data0, state, true);
  case 0x37:
    return -1;
  case 0x38:
    return -1;
  ...
  case 0x76:
    return -1;
  case 0x77:
    return instr_LD_mem_r1_nn(REG_HL(state), state.A, state, false);
  case 0x78:
  ...
  case 0xDF:
    return -1;
  case 0xE0:
    return instr_LD_FF00_n_A(state, state.C, true);
  case 0xE1:
  ...
  case 0xE9:
    return -1;
  case 0xEA:
    return instr_LD_mem_r1_nn(JOIN_REGS(data1,data0), state.A, state, true);
  case 0xEB:
    return -1;
  case 0xEC:
    return -1;
